# Plugins and One Shot

**Plugins** is a drawer of mini-apps inside HydraOps. Open it from **Plugins** in the sidebar (above *Tasks*); it shows up as a window without taking you away from what you were doing. Today it holds a single mini-app: **One Shot** (in beta).
...
> One Shot is in **beta**: nodes are generic text for now. Typed or image nodes, diagram templates, and more mini-apps will come later.
