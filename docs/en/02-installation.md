...
That brings up the whole stack and leaves the application at `http://127.0.0.1:3000`. The command's output prints the exact URLs. To keep it running 24/7 or open it to your local network, continue in [Server mode](./12-server-mode.md).
